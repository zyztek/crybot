          ...
          {result === 'success' && (
            <div className="bg-green-500/20 rounded-lg p-4 border border-green-500/30">
              ...
              <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="text-slate-400">{text.estimatedCost}:</span> $0.89
                </div>
                <div>
                  <span className="text-slate-400">{text.executionTime}:</span> 1.2s
                </div>
              </div>
            </div>
          )}
