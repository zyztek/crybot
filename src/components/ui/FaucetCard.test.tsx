...
describe('FaucetCard', () => {
  it('renders faucet name correctly', () => {
    ...
    renderComponent(<FaucetCard faucet={mockFaucet} onClaim={handleClaim} language="es" />);
  ...
  it('shows claim button when status is available (English)', () => {
    const handleClaim = vi.fn();
    renderComponent(<FaucetCard faucet={mockFaucet} onClaim={handleClaim} language="en" />);
  ...
  it('shows timer button when status is wait (Spanish)', () => {
    const handleClaim = vi.fn();
    renderComponent(<FaucetCard faucet={mockFaucetWait} onClaim={handleClaim} language="es" />);
  ...
  it('shows timer button when status is wait (English)', () => {
    const handleClaim = vi.fn();
    renderComponent(<FaucetCard faucet={mockFaucetWait} onClaim={handleClaim} language="en" />);
  ...
  it('renders featured variant with crown icon', () => {
    ...
    const { container } = renderComponent(
      <FaucetCard faucet={mockFaucet} onClaim={handleClaim} featured={true} language="es" />
    );
  ...
  it('renders different coin colors for BTC', () => {
    const handleClaim = vi.fn();
    const { container } = renderComponent(
      <FaucetCard faucet={mockFaucet} onClaim={handleClaim} language="es" />
    );
  ...
  it('renders different coin colors for ETH', () => {
    ...
    const { container } = renderComponent(
      <FaucetCard faucet={ethFaucet} onClaim={handleClaim} language="es" />
    );
