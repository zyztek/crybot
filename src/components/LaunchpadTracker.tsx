...
const projects: LaunchpadProject[] = [
  {
    ...
    logo: '🔷',
    description: 'Protocolo DeFi de próxima generación con farming optimizado',
    chain: 'Ethereum',
    status: 'live',
    saleType: 'ido',
  ...
  },
  {
    ...
    name: 'Metaverse Game',
    logo: '🎮',
    description: 'Juego play-to-earn en el metaverse con economy real',
    chain: 'Solana',
    status: 'staking',
    saleType: 'ino',
  ...
  },
  {
    ...
    logo: '🤖',
    description: 'Protocolo descentralizado de IA con chat privado',
    chain: 'Binance',
    status: 'upcoming',
    saleType: 'ido',
  ...
  },
  {
    ...
    logo: '🌱',
    description: 'DAO de energía renovable con tokenización de activos',
    chain: 'Polygon',
    status: 'live',
    saleType: 'ido',
  ...
  },
  {
    ...
    logo: '🖼️',
    description: 'Marketplace de NFTs con fees reducidos y royalties',
    chain: 'Avalanche',
    status: 'upcoming',
    saleType: 'ieo',
  ...
  },
  {
    ...
    logo: '🌉',
    description: 'Bridge cross-chain con seguridad y速度快',
    chain: 'Arbitrum',
    status: 'staking',
    saleType: 'ido',
  ...
  },
  {
    ...
    logo: '💬',
    description: 'Red social descentralizada con monetización',
    chain: 'Ethereum',
    status: 'upcoming',
    saleType: 'ido',
  ...
  {
    id: 8,
    name: 'Privacy Layer One',
    logo: '🔒',
    description: 'L1 blockchain enfocada en privacidad',
    chain: 'Native',
    status: 'ended',
    saleType: 'ido',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">
            Descubre las mejores opportunities en IDOs, IEOs y token sales
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 backdrop-blur-sm rounded-xl p-5 border border-blue-500/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">
                  ${(stats.totalCap / 1000000).toFixed(2)}M
                </p>
              </div>
            </div>
          </div>
              ...
              {['all', 'live', 'staking', 'upcoming', 'ended'].map(status => (
                ...
                >
                  {status === 'all' ? (
                    ...
                    <>
                      <Flame className="w-4 h-4" /> En Vivo
                    </>
                  ) : status === 'staking' ? (
                    <>
                      <Zap className="w-4 h-4" /> Staking
                    </>
                  ) : status === 'upcoming' ? (
                    <>
              ...
              >
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="px-2 py-0.5 rounded-full text-xs bg-slate-700 text-white uppercase">
                            {project.saleType}
                          </span>
                        </div>
                      </div>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium border flex items-center gap-1 ${getStatusColor(project.status)}`}
                    >
                      {getStatusIcon(project.status)}
                      {project.status === 'live'
                        ? '🔥 Live'
                        : project.status === 'staking'
                          ? '⚡ Staking'
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-200/80">
                Las inversiones en IDOs/IEOs conllevan riesgos significativos. Investiga cada
                proyecto a fondo antes de participar. No inviertas dinero que no puedes permitirte
                perder.
              </p>
            </div>
          </div>
