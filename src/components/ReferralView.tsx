    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-xl p-6 backdrop-blur-sm">
          {/* Current tier badge */}
          <div
            className={`mb-4 p-4 rounded-xl bg-gradient-to-r ${currentTier.color} border ${currentTier.borderColor}`}
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-bold text-lg">
                    {isSpanish ? currentTier.nameES : currentTier.name}
                  </p>
            ...
            {nextTier && (
              <div className="mt-4">
                <div className="flex justify-between text-white/70 text-xs mb-1">
                  <span>
                    {nextTier.minReferrals - user.totalReferrals} más para{' '}
                    {isSpanish ? nextTier.nameES : nextTier.name}
                  </span>
                  ...
                  >
                    ...
                    <div className="mt-2 flex flex-wrap gap-1">
                      {tier.benefits.map((benefit, i) => (
                        <span
                          key={i}
                          className="px-2 py-0.5 bg-slate-800/50 text-purple-300 text-xs rounded"
                        >
                          {benefit}
                        </span>
                      ))}
          ...
          <div className="bg-slate-800 border border-purple-500/30 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div className="space-y-3">
              <div className="bg-slate-900/50 rounded-lg p-4">
                <p className="text-purple-300 text-sm mb-2">
                  {isSpanish ? 'Enlace de referido' : 'Referral Link'}
                </p>
                <div className="flex items-center gap-2">
            ...
            <div className="mt-4 p-3 bg-slate-900/30 rounded-lg">
              <p className="text-xs text-slate-400 mb-1">
                {isSpanish ? 'Vista previa del mensaje' : 'Message preview'}
              </p>
