...
describe('DashboardView', () => {
  it('renders history section title', () => {
    render(<DashboardView history={mockHistory} achievements={mockAchievements} t={mockTranslations} language="es" />)
  ...
  it('renders weekly stats section in English', () => {
    const tEn: TranslationTexts = { ...mockTranslations, history: 'History', achievementsTitle: 'Your Achievements' }
    render(<DashboardView history={mockHistory} achievements={mockAchievements} t={tEn} language="en" />)
  ...
  it('renders empty state when history is empty', () => {
    render(<DashboardView history={[]} achievements={mockAchievements} t={mockTranslations} language="es" />)
