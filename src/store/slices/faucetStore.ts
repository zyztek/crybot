...
export const INITIAL_FAUCETS: Faucet[] = [
  ...
  { id: 3, name: 'Cointiply', coin: 'DOGE', icon: 'Ð', reward: '5.50', timer: 45, status: 'available', category: 'stable', difficulty: 'easy', translations: { es: 'Moneda Gratis', en: 'Free Coins' } },
  { id: 4, name: 'FaucetCrypto', coin: 'SOL', icon: '◎', reward: '0.01', timer: 20, status: 'available', category: 'hot', difficulty: 'medium', translations: { es: 'Crypto Faucet', en: 'Crypto Faucet' } },
  { id: 5, name: 'BonusBitcoin', coin: 'BTC', icon: '₿', reward: '0.00000500', timer: 15, status: 'available', category: 'stable', difficulty: 'easy', translations: { es: 'Bonus Bitcoin', en: 'Bonus Bitcoin' } },
  { id: 6, name: 'ADBTC', coin: 'BTC', icon: '₿', reward: '0.00000300', timer: 10, status: 'available', category: 'stable', difficulty: 'hard', translations: { es: 'Bitcoin Ads', en: 'Bitcoin Ads' } },
  { id: 7, name: 'GetFreeBTC', coin: 'BTC', icon: '₿', reward: '0.00000200', timer: 5, status: 'available', category: 'new', difficulty: 'easy', translations: { es: 'BTC Gratis', en: 'Get Free BTC' } },
  { id: 8, name: 'EthFaucet', coin: 'ETH', icon: 'Ξ', reward: '0.0001', timer: 40, status: 'available', category: 'hot', difficulty: 'easy', translations: { es: 'Faucet ETH', en: 'ETH Faucet' } },
  { id: 9, name: 'LTCFaucet', coin: 'LTC', icon: 'Ł', reward: '0.001', timer: 25, status: 'available', category: 'new', difficulty: 'medium', translations: { es: 'Faucet LTC', en: 'LTC Faucet' } },
  { id: 10, name: 'DogeClaim', coin: 'DOGE', icon: 'Ð', reward: '8.00', timer: 35, status: 'available', category: 'stable', difficulty: 'easy', translations: { es: 'Claim Doge', en: 'Doge Claim' } },
  { id: 11, name: 'SolanaDrop', coin: 'SOL', icon: '◎', reward: '0.015', timer: 50, status: 'available', category: 'premium', difficulty: 'medium', translations: { es: 'Solana Drop', en: 'Solana Drop' } },
  { id: 12, name: 'BNBFaucet', coin: 'BNB', icon: '⬡', reward: '0.002', timer: 60, status: 'available', category: 'hot', difficulty: 'hard', translations: { es: 'Faucet BNB', en: 'BNB Faucet' } },
]
...
export const INITIAL_HISTORY: ClaimHistory[] = [
  ...
  { id: 3, faucet: 'Cointiply', faucetId: 3, coin: 'DOGE', amount: '5.50', time: '13:50', date: 'Hoy' },
]
...
export const createFaucetStore: StateCreator<FaucetState> = (set: any, get: any, api: any) => ({
  ...
  claimFaucet: (faucet, onCountdownEnd, actions) => {
    ...
    if (actions?.updateAchievementProgress) {
      ...
      const currentAchievements = (get() as unknown as { achievements?: { id: number; progress: number }[] })?.achievements
