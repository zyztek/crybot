...
describe('getFriendlyError', () => {
  ...
  it('should map connection errors to user-friendly message', () => {
    ...
    expect(getFriendlyError(error)).toBe(
  ...
  it('should handle non-Error objects', () => {
    expect(getFriendlyError('string error')).toBe(
    ...
    expect(getFriendlyError({ message: 'obj' })).toBe(
      'An unexpected error occurred. Please try again.'
    );
  });
  ...
  it('should handle long technical error messages', () => {
    const longMessage =
      'This is a very long technical error message that contains many details about what went wrong in the system including stack traces and debugging information that users should not see';
...
describe('Success toast messages', () => {
  ...
  it('should store registration success message', () => {
    ...
    addToast({
      type: 'success',
      message: 'Account created successfully! Welcome to CryptoFaucet Hub.',
    });
