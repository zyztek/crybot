...
router.get('/:coin', authenticate, asyncHandler(async (req: AuthRequest, res) => {
...
router.post('/deposit', authenticate, asyncHandler(async (req: AuthRequest, res) => {
...
router.post('/withdraw', authenticate, asyncHandler(async (req: AuthRequest, res) => {
  const coinBody = req.body?.coin;
